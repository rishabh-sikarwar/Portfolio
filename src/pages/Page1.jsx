  ...
  return (
    <>
      <div
        ...
        className="relative h-screen  p-6"
      >
        <div className="absolute inset-0 rounded-[50px] overflow-hidden bg-gradient-to-b from-[#111827] via-[#1f2937] to-[#374151] shadow-[#8ab4f1] m-3 shadow-xl"></div>
