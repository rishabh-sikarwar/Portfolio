...
const Page2 = () => {
  ...
  return (
    <div
      id="section2"
      className="bg-white text-black text-center p-32 uppercase leading-[35vw]"
    >
      <h3 className="text-gray-500 text-3xl font-[anzo3]">
        © 2025 Rishabh Sikarwar® | Designed and Developed
      </h3>
      <div className="h1 mt-40">
        <h1 className="text-[42vw] font-[anzo12] text-black">IMPACTFUL</h1>
      </div>
      <div className="h1">
        <h1 className="text-[42vw] font-[anzo12] text-black">DESIGN</h1>
      </div>
      <div className="h1">
        <h1 className="text-[42vw] font-[anzo12] text-black">IS THE</h1>
      </div>
      <div className="h1">
        <h1 className="text-[42vw] font-[anzo12] text-black">DESIGN</h1>
      </div>
      ...
      <div className='flex justify-center items-center scale-75 mt-24'>
        ...
        >
            ...
            <g clipPath="url(#96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2)">
              <g filter="url(#aef381e0-a01b-4767-81f9-2c2e04143cb9_comp-lmyox36t2)">
                <mask
                  ...
                  id="6fdfdaea-c66e-4c33-992f-dbf7b68cfcfcfc_comp-lmyox36t2"
                  fill="none"
                >
                  <path
                    fill="#ffffff"
                    d="M915.657 19.798H803.585v43.39h112.072v-43.39Z"
                  ></path>
                </mask>
          ...
          <div className='h-1 w-1/3 bg-black relative left-1/2 -translate-x-1/2 mt-16'></div>
    </div>
  );
}
