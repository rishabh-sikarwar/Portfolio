  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          className="bg-gradient-to-r from-green-500 to-blue-500 px-10 py-5 mt-5 rounded-full text-white border-4 text-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 "
